...
for line in lines :                                         #for each line
    ...
    if (int(pair1[0]) >= int(pair2[0]) and int(pair1[1]) <= int(pair2[1])) or (int(pair2[0]) >= int(pair1[0]) and int(pair2[1]) <= int(pair1[1])) or (int(pair2[1]) >= int(pair1[0]) >= int(pair2[0])) or (int(pair1[1]) >= int(pair2[0]) >= int(pair1[0])) :      #if contain in a sens and other sens
